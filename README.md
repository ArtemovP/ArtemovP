...
С ноября 2023 работаю аналитиком данных парка "Сказка".
Занимаюсь выгрузкой из различных источников (SQL, API, парсинг страниц сайтов), обработкой, анализом (Python, библиотеки Pandas, Numpy, Scipy, pingouin, statsmodels и др.) и визуализацией данных (Python библиотеки Seaborn, Matplotlib.  Для дашбордов следующие BI - Tableau, Яндекс Data.Lens, Google Looker Studio), поисклм инсайтов по данным, подготовкой отчетов для вышестоящего руководства по итогу исследования данных, а так же за отчетный период.
